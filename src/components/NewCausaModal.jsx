...
export default function NewCausaModal({ onClose, onCreate }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      <div className="glass-panel relative w-full max-w-xl rounded-2xl border border-slate-700/80 bg-slate-900 shadow-2xl overflow-visible my-8">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {(formData.flagrancia !== 'SI' && formData.flagrancia !== 'SÍ') && (formData.indagatoria === 'SI' || formData.indagatoria === 'SÍ') && (() => {
              ...
              return (
                <div className="col-span-2 rounded-xl p-4 border border-amber-500/40 bg-amber-500/10 space-y-3 shadow-inner">
                    ...
                    <div className="space-y-3 pt-2.5 border-t border-amber-500/25">
                      ...
                      <div className="rounded-xl bg-slate-950/90 p-3 border border-amber-500/40 space-y-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 border-t border-slate-800 text-[11px]">
                          <div className="flex items-center justify-between bg-slate-900/80 px-2.5 py-1.5 rounded-lg border border-slate-800">
                            ...
                            <span className="font-extrabold text-amber-300">
                              {ippProrrogas.length > 0 ? `+${currentTotalIPPMonths - 4} meses` : 'Sin prórroga (0m)'}
                            </span>
                          </div>
                        ...
                        <div className="text-[10px] text-slate-400 text-center font-mono pt-0.5">
                          {currentTotalIPPMonths} meses acumulados desde fecha de indagatoria ({formData.fecha_indagatoria})
                        </div>
                      </div>
                      ...
                      <div className="pt-1">
                        {remainingMonths > 0 ? (
                          ...
                          <div className="rounded-xl bg-amber-500/20 p-3 border border-amber-500/50 text-[11px] font-bold text-amber-300 flex items-center justify-center gap-2 text-center shadow-inner">
                            <span>🔒 Se ha alcanzado el límite máximo legal de 10 meses totales desde la fecha de indagatoria.</span>
                          </div>
                        )}
                      </div>
                    </div>
